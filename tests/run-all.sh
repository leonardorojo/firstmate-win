...
suites=("$@")
[ "${#suites[@]}" -gt 0 ] || suites=(paths.test.sh project-registry.test.sh worktree-safety.test.sh firstmate-adapter.test.sh fase6-recovery.test.sh profile-ingenieumapp.test.sh runtime.test.sh reconcile.test.sh multirepo.test.sh)
